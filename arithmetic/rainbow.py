...
mc.setBlock(x, y, z, wool,10)
mc.setBlock(x + 1, y, z, wool,10)
mc.setBlock(x + 2, y, z, wool,10)

# Increase y to place next block above
y = y + 1

# Place the blue wool
mc.setBlock(x, y, z, wool,11)
mc.setBlock(x + 1, y, z, wool,11)
mc.setBlock(x + 2, y, z, wool,11)

# Increase y to place next block above
y = y + 1

# Place the green wool
mc.setBlock(x, y, z, wool,13)
mc.setBlock(x + 1, y, z, wool,13)
mc.setBlock(x + 2, y, z, wool,13)
...
mc.setBlock(x, y, z, wool,14)
mc.setBlock(x + 1, y, z, wool,14)
mc.setBlock(x + 2, y, z, wool,14)
